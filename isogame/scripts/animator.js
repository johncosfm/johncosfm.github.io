...
//PLAYER ANIMS
	...
	player__anim_cin03_doorinteract_unlocked : {
		...
		rootMotion : false,
		animEvents : {0 : "playSoundEvent('snd__player_step'); document.getElementById('player').dataset.sequence_direction = 'dir_225'; gassttationDoorInteractOpen()"},
	},
//CLOSEUP ANIMS
...
//ENVIRONMENT ANIMS
	...
	env__gasstation_ext_door__anim_action : {
		...
		rootMotion : false,
		animEvents : {0 : "playSoundEvent('snd__scripted__gasstation_door_open')"},
	},
